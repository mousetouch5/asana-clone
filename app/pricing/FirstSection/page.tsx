...
const FirstSection = () => {
  ...
  return (
    <div className="relative min-h-screen w-full">
      <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-60 z-10 pointer-events-none">
        <span className="text-white text-4xl font-bold text-center">
          Comming soon
        </span>
      </div>
      <div className="flex flex-col space-y-10  pb-20 items-center justify-center blur-lg">
        <div className="space-y-6 flex flex-col text-center pt-20 px-10 md:px-0">
          ...
          <div className="text-2xl text-gray-500">
            Access Clone features. No credit card required
          </div>
        </div>
        ...
        <div className="">
          ...
          <div className="md:flex p-10 md:space-x-10 space-y-10 md:space-y-0 items-center justify-center md:w-3/4 md:mx-auto">
            <div className="border-gray-500 p-10 rounded-lg border space-y-8 md:w-1/2 ">
              ...
              <div className="text-5xl font-semibold">PHP 0</div>

              <div className="">
                Per user, per month billed annually PHP144.00
              </div>
            ...
            <div className="border-purple-500 p-10 rounded-lg border space-y-8 md:w-1/2">
              ...
              {isMonthlyPlan ? (
                <div>
                  <div className="text-5xl font-semibold">PHP12.00</div>
                </div>
              ) : (
                <div className="text-5xl font-semibold">PHP129.99</div>
              )}
            ...
            <div className="border-teal-500 p-10 rounded-lg border space-y-8 md:w-1/2">
              ...
              {isMonthlyPlan ? (
                <div>
                  <div className="text-5xl font-semibold">PHP39.99</div>
                </div>
              ) : (
                <div className="text-5xl font-semibold">PHP329.99</div>
              )}
